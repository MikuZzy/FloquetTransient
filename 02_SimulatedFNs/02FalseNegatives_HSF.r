# This file creates synthetic data based on the full model fit for gene HSF and apply our method to them. 
...
write.csv(FNs_nosel, file = '02Result_HSF_nosel.csv')
write.csv(FNs_withsel, file = '02Result_HSF_withsel.csv')
save.image(file = '02FalseNegatives_HSF.Rdata')
