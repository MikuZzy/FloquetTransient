# This file works with synthetic data with transient changes, and compare three different sampling schemes
# using our method. This file is run on HPC cluster (mclapply function) and the output .Rdata file is used
...
save.image(file='00.02SyntheticData_nolambda.Rdata')
